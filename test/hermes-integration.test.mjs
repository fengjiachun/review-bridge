...
test("Hermes install and release artifacts use the 0.16.0 release identity", async () => {
  ...
  assert.match(hermesReadme, /exact `v0\.15\.3` tag/);
  ...
  assert.match(server, /version: "0\.15\.3"/);
  ...
  assert.match(rootReadme, /v0\.15\.3/);
  assert.match(hermesReadme, /v0\.15\.3/);
  assert.match(hermesAuthorConfig, /v0\.15\.3/);
  assert.match(hermesReviewerConfig, /v0\.15\.3/);
  assert.match(deepseekReadme, /exact `v0\.15\.3` tag/);
  assert.match(deepseekAuthorPatch, /v0\.15\.3/);
  assert.match(deepseekReviewerPatch, /v0\.15\.3/);
