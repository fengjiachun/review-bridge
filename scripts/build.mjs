...
const mcpbOutput = path.join(outputRoot, "review-bridge-reviewer-v0.1.0.mcpb");
const dxtOutput = path.join(outputRoot, "review-bridge-reviewer-v0.1.0.dxt");
const sourceOutput = path.join(outputRoot, "review-bridge-source-v0.1.0.zip");
