...
reviewer against one store. The version examples below use `v0.8.1`; substitute
...
npm ci
npm run build
codex plugin marketplace add "$(pwd)/dist/review-bridge-v0.8.1/codex-marketplace"
```
...
absolute, versioned `review-bridge-v0.8.1/hermes-integration` directory and
...
- `review-bridge-reviewer-v0.8.1.mcpb` — MCP Bundle for Claude Desktop.
- `review-bridge-reviewer-v0.8.1.dxt` — compatibility copy of the same bundle.
...
```bash
node dist/review-bridge-v0.8.1/codex-marketplace/plugins/review-bridge/scripts/collect-github-observation.mjs --review-id <review_id>
```
